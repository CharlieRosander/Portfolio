...
class ModelTrainerApp(tk.Tk):
    ...
    def create_training_tab(self):
        ...
        ttk.Label(
            training_frame, text="Specify the path to save the trained model\n(Default is root/saved_models/model.keras)"
        ).pack(pady=5)
    ...
    def show_random_predictions(self):
        ...
        predicted_probs = tf.nn.sigmoid(predictions).numpy()
        ...
        for i, idx in enumerate(rand_indices):
            ...
            pred_prob = predicted_probs[idx][0]  # Extract scalar value
